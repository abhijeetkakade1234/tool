...
const toolRoutes: [string, LazyExoticComponent<ComponentType>][] = [
  ...
  ["/image/ocr", lazy(() => import("@/features/images/ocr/OcrPage"))],
  ...
  ["/pdf/sign", lazy(() => import("@/features/pdf/sign/PdfSignPage"))],
  ["/video/trim", lazy(() => import("@/features/video/trim/VideoTrimPage"))],
  ["/video/split", lazy(() => import("@/features/video/split/VideoSplitPage"))],
  ["/video/mute", lazy(() => import("@/features/video/mute/VideoMutePage"))],
  ["/video/to-audio", lazy(() => import("@/features/video/toAudio/VideoToAudioPage"))],
  ["/video/convert", lazy(() => import("@/features/video/convert/VideoConvertPage"))],
  ["/video/gif", lazy(() => import("@/features/video/gif/VideoToGifPage"))],
